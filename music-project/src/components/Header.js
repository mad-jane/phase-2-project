    ...
    return (
        <div>
            <div className="app-header">
                <img className="logo" src='/Users/mad/development/code/phase-2/phase-2-project/music-project/src/assets/transparent-2-audio-house.png' alt='audio-house-logo'></img>
            </div>
